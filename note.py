...
# # using escap sequances
# # => \n, \t, \', \", \\

# print('one\ntwo\nthree\n'.title())
# print('one\ttwo\tthre'.title())
# print('he is a good \'programmer\''.title())
# print("he is a good \"programmer\" ".capitalize() )
...
# this program is printing the decimal digits without formating

amount_due = 7000

monthly_payment = amount_due / 12

# format method will format the digits numbers and allows to convert
# numbers to string and round it to th e2 dicemal point
print('the monthly payment is $'.title() + format(monthly_payment,'.2f'))


  

# this program will seprate each 3 digits with comma and round the # dicmal fraction to 2
print('$', format(1233423.23343,',.2f'), sep = '')
